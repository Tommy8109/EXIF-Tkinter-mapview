EXIF DATA VISUALISER IN PYTHON
...
Image above shows the second screen, after a file has been chosen. The program shows the make, model and software of the camera used, alongside
